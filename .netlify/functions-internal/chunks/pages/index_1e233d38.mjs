/* empty css                           */import { e as createAstro, f as createComponent, r as renderTemplate, j as renderComponent, m as maybeRenderHead } from '../astro_6201b302.mjs';
import 'clsx';
import { $ as $$Navigation, T as ThemeToggle, e as $$Icon, b as $$Button, d as $$Layout } from './happy_abeb2012.mjs';
import 'html-escaper';
import 'svgo';
import 'react';
...
Portfolio is being rebuild from scratch with captivating cases, beautifull features and.. a performing website.
<br><b>Q1 2024</b></p></div>${renderComponent($$result2, "Button", $$Button, { "title": "visit previous portfolio", "link": "https://mbsn.webflow.io/" })}</div></main>` })}`;
}, "/Users/baysamua/Documents/website/astro/musabaysan/src/pages/index.astro", void 0);
